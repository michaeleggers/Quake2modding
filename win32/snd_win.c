...
sndinitstat SNDDMA_InitDirect (void)
{
	...
	if ( !hInstDS )
	{
		...
		Com_DPrintf ("ok\n");
		DSoundCreate = (pDirectSoundCreate)GetProcAddress(hInstDS,"DirectSoundCreate");
